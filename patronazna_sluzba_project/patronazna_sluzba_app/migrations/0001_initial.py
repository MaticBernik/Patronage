# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-05-18 00:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('datum_zacetek', models.DateTimeField(default=datetime.datetime(2017, 5, 18, 2, 11, 13, 726612))),
                ('datum_konec', models.DateTimeField(default=datetime.datetime(2017, 5, 19, 2, 11, 13, 726635))),
            ],
        ),
        migrations.CreateModel(
            name='Obisk',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('datum', models.DateTimeField(default=datetime.datetime(2017, 5, 19, 2, 11, 13, 724961))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profil', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Vodja_PS',
