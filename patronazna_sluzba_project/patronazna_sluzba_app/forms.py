...
class RegistrationFrom(forms.Form):
   ...
   contact_surname = forms.CharField(label='Priimek:', max_length=100, widget=forms.TextInput(attrs={'class': 'form-control'}))
   contact_name = forms.CharField(label='Ime:', max_length=100, widget=forms.TextInput(attrs={'class': 'form-control'}))
   contact_address = forms.CharField(label='Naslov:', max_length=100, widget=forms.TextInput(attrs={'class': 'form-control'}))
   contact_phone_number = forms.CharField(label='Telefon', max_length=100, widget=forms.NumberInput(attrs={'class': 'form-control'}))
   contact_sorodstvo = forms.CharField(label='Naslov:', max_length=100, widget=forms.TextInput(attrs={'class': 'form-control'}))
