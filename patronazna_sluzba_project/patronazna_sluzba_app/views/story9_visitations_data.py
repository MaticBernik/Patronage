...
def list_active_visitations(request):
    ...
    context = {'work_task_list':delovni_nalogi, 'visitations_list_today':visitations, 'visitations_list_yesterday':visitations, 'nbar': 'v_nrs_visits_data', 'filter_form': filter_form, 'medications':zdravila, 'material': material, 'pacient_list': pacienti, 'doctors': zdravniki, 'head_nurses': vodje_ps}
