# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-06-02 05:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aktiven', models.NullBooleanField(default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('datum_zacetek', models.DateTimeField(default=datetime.datetime(2017, 6, 2, 5, 3, 16, 285807))),
                ('datum_konec', models.DateTimeField(default=datetime.datetime(2017, 6, 3, 5, 3, 16, 285830))),
                ('veljavno', models.BooleanField(default=0)),
            ],
        ),
        migrations.CreateModel(
            name='Obisk',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('datum', models.DateTimeField(default=datetime.datetime(2017, 6, 3, 5, 3, 16, 284205))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('meritev', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='patronazna_sluzba_app.Meritev')),
            ],
        ),
        migrations.CreateModel(
            name='Polje_v_porocilu',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ime', models.CharField(max_length=100, null=True)),
                ('vnosno_polje', models.CharField(max_length=100, null=True)),
                ('obvezno', models.BooleanField(default=0)),
                ('mozne_vrednosti', models.CharField(max_length=100, null=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('vrednost', models.CharField(max_length=100)),
                ...
                ('polje', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='patronazna_sluzba_app.Polje_v_porocilu')),
            ],
        ),
        migrations.CreateModel(
            name='Posta',
        ...
        migrations.AddField(
            model_name='polje_meritev',
            name='polje',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='patronazna_sluzba_app.Polje_v_porocilu'),
        ),
        migrations.AddField(
