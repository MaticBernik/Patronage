...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('datum_zacetek', models.DateTimeField(default=datetime.datetime(2017, 5, 18, 11, 40, 26, 862649))),
                ('datum_konec', models.DateTimeField(default=datetime.datetime(2017, 5, 19, 11, 40, 26, 862676))),
            ],
        ),
        migrations.CreateModel(
            name='Obisk',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('datum', models.DateTimeField(default=datetime.datetime(2017, 5, 19, 11, 40, 26, 860771))),
